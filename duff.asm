...
ciclo_duff:        
        slt     $t1, $t9, $zero         # arrivo fino allo zero
        bne     $t1, $zero, ok 
        addu    $t2, $t9, $s1           # mi posiziono sull'elemento memoria
        lbu     $t6, 0($t2)             # carico in $se risultati
...
# $t0, $t1, $t2, $t3, $t9 non usabili per ciclo